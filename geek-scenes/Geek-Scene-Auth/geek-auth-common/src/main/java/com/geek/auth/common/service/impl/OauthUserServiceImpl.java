package com.geek.auth.common.service.impl;
...
import com.geek.auth.common.mapper.OauthUserMapper;
...
public class OauthUserServiceImpl implements IOauthUserService {
    ...
    public SysUser selectSysUserByUUID(String uuid) {
        ...
        if (StringUtils.isNotNull(oauthUser)) {
            return sysUserMapper.selectOneWithRelationsById(oauthUser.getUserId());
        } else {
            return null;
        }
    }
