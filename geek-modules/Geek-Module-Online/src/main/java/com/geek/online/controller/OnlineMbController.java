...
import com.geek.online.domain.OnlineMb;
import com.geek.online.service.IOnlineMbService;
...
public class OnlineMbController extends BaseController
{
    ...
    @GetMapping("/list")
    public TableDataInfo<OnlineMb> list(OnlineMb onlineMb)
    {
        startPage();
    ...
    {
        List<OnlineMb> list = onlineMbService.selectOnlineMbList(onlineMb);
        ExcelUtil<OnlineMb> util = new ExcelUtil<>(OnlineMb.class);
