...
import com.geek.modelMessage.service.IMessageVariableService;
...
public class MessageVariableController extends BaseController
{
    ...
    @GetMapping("/list")
    public TableDataInfo<MessageVariable> list(MessageVariable messageVariable)
    {
        startPage();
    ...
    {
        List<MessageVariable> list = messageVariableService.selectMessageVariableList(messageVariable);
        ExcelUtil<MessageVariable> util = new ExcelUtil<>(MessageVariable.class);
